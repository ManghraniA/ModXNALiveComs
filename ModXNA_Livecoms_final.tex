...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pubDOI{10.33011/livecoms.6.1.4545}
\pubvolume{6}
\pubissue{1}
\pubyear{2025}
\articlenum{4545}
\datereceived{08 September 2025}
\dateaccepted{19 December 2025}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/ModXNA_general_pipeline.png}
